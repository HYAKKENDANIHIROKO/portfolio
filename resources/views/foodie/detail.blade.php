        ...
        <div class="container mt-5">
            <div class="row">
                <div class="border p-5 mt-5 bg-light col-md-12 mx-auto">
                    <div class="header">
                        <div class="header-wrapper">
                            <!--お店の名前・値段・口コミ投稿ページへのリンク・リラックス度と料理のボリューム度の各平均値が入る-->
                ...
                <ul class="nav nav-pills mb-5 nav-fill col-md-12" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-map-tab" data-toggle="pill" href="#pills-map" role="tab" aria-controls="pills-map" aria-selected="false">住所</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="pills-tabContent col-md-12">
                    ...
                    <div class="tab-pane fade m-4" id="pills-comment" role="tabpanel" aria-labelledby="pills-comment-tab">口コミ一覧(最新順です)
                        ...
                        <!--口コミ投稿を最新順に並べる-->
                        @forelse ($shop->comments()->latest()->get() as $comment)
