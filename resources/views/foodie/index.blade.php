    ...
    <div class="top-wrapper"> 
        <div class="jumbotron jumbotron-extend" style="maragin:90px 0">
            <div class="container">
                ...
                <!--各お店に入れるリラックス度と料理のボリューム度に関する指標の説明-->
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        <p class="relax_guidline mr-2" style="font-size:25px;">リラックス度：<span class="fa-solid fa-face-frown blue-face fa-lg mr-1"></span>1
                            ...
                            <span class="fa-solid fa-face-grin-beam orange-face fa-lg mr-1"></span>4<span class="fa-solid fa-face-grin-squint red-face fa-lg mr-1"></span>5
                        </p>
                    </div>
                    <div class="col-md-6">
                        <p class="volume_guidline mr-2" style="font-size:25px;">料理のボリューム度：<span class="far fa-frown b-face fa-lg mr-1"></span>1
                            ...
                            <span class="far fa-grin-beam o-face fa-lg mr-1"></span>4<span class="far fa-grin-squint r-face fa-lg mr-1"></span>5
                        </p>
                    </div>
                    <div class="w-100"></div>
                </div>
